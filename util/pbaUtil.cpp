...
bool LoadNVM(ifstream& in, vector<CameraT>& camera_data, vector<string>& names, vector<PtCamCorr>& pt_corr, map<int,vector<ImgFeature> >& in_map, map<string,int> &out_map)
{
